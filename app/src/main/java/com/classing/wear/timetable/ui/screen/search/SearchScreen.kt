...
/**
 * Search leads with the watch input prompt because dictation and handwriting are the
 * realistic entry points on a watch. The text field stays underneath so the existing
 * typed query path is untouched.
 */
@Composable
fun SearchScreen(
    state: SearchUiState,
