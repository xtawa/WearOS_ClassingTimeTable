...
private val ClassingLightColorScheme = lightColorScheme(
    ...
    surfaceDim = ClassingColors.SurfaceSecondaryLight,
    surfaceBright = ClassingColors.SurfaceStrongLight,
    surfaceContainerLowest = ClassingColors.SurfaceStrongLight,
    surfaceContainerLow = ClassingColors.SurfaceLight,
    surfaceContainer = ClassingColors.SurfaceSecondaryLight,
    surfaceContainerHigh = ClassingColors.OutlineSoftLight,
    surfaceContainerHighest = ClassingColors.OutlineSoftLight,
...
private val ClassingDarkColorScheme = darkColorScheme(
    ...
    surfaceDim = ClassingColors.BackgroundDark,
    surfaceBright = ClassingColors.SurfaceStrongDark,
    surfaceContainerLowest = ClassingColors.BackgroundDark,
    surfaceContainerLow = ClassingColors.SurfaceDark,
    surfaceContainer = ClassingColors.SurfaceSecondaryDark,
    surfaceContainerHigh = ClassingColors.SurfaceStrongDark,
    surfaceContainerHighest = ClassingColors.SurfaceStrongDark,
